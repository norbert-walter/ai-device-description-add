...
![AI Server GPU Dashboard](AI_Server_Dashboard_EN.png)
...
![Overview of Data Processing in the Dashboard](Dashboard_Data_Flow_EN.png)
...
![Dashboard and API Endpoints](Dashboard_Endpoints_EN.png)
