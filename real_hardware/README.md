...
```
> **Tip:** If the AI ​​refuses to read the endpoint
> https://yachta.norbert-walter.dnshome.de/add
> because it is not an HTML page, use the following endpoint:
> https://yachta.norbert-walter.dnshome.de/add.html
...
<img src="../pictures/Dashboard_Claude_Sonnet4.png" alt="Dashboard Claude Sonnet4" width="400">
