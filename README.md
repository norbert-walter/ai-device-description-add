...
| **Industrial plant component model** | Equip a real functional model of an industrial plant component with ADD and run simulations, extending validation from single devices (sensors, cooling valve) to a representative multi-component system |
